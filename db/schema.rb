...
ActiveRecord::Schema.define(version: 2020_12_08_020635) do
  ...
  create_table "client_properties", force: :cascade do |t|
    ...
    t.index ["client_id"], name: "index_client_properties_on_client_id"
    t.index ["property_id"], name: "index_client_properties_on_property_id"
  end
